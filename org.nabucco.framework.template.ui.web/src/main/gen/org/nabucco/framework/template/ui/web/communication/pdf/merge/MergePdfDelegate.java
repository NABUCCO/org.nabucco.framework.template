 ...
 */
package org.nabucco.framework.template.ui.web.communication.pdf.merge;
...
public class MergePdfDelegate extends ServiceDelegateSupport {
     ...
     */
    public MergePdfRs mergePdfFiles(MergePdfRq message, NabuccoSession session, ServiceSubContext... subContexts)
            throws TemplateException {
        ServiceRequest<MergePdfRq> request = new ServiceRequest<MergePdfRq>(super.createServiceContext(session,
                subContexts));
        ...
        throw new TemplateException("Cannot execute service operation: MergePdf.mergePdfFiles");
    }
}
