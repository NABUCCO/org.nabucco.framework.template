 ...
 */
package org.nabucco.framework.template.ui.rcp.communication.textmodule.produce;
...
public class ProduceTextModuleDelegate extends ServiceDelegateSupport {
     ...
     */
    public TextModuleListMsg produceTextModule(TextModuleProduceRq message, ServiceSubContext... subContexts)
            throws ClientException {
        ...
        throw new ClientException("Cannot execute service operation: ProduceTextModule.produceTextModule");
    }
}
