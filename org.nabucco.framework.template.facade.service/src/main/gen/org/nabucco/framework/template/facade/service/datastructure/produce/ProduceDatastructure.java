 ...
 */
package org.nabucco.framework.template.facade.service.datastructure.produce;
...
/**
 * ProduceDatastructure<p/>Producer service for datastructure<p/>
 *
 * @version 1.0
 * @author Leonid Agranovskiy, PRODYNA AG, 2012-07-04
 */
public interface ProduceDatastructure extends Service {
     ...
     */
    ServiceResponse<ProduceDSRs> produceDatastructureFromTemplate(ServiceRequest<ProduceDSRq> rq)
            throws ProduceException;
}
